    ...
    def gamePage(self):
        while True:
            ...
            if self.operations.get_color(monitor_seller_banner_location, reason='seller-monitor check') == SummonerColors.MONITOR_SELLER_SCROLL:
                ...
                time.sleep(1)
                if self.operations.get_color(monitor_seller_character_location, reason='confirm seller') == SummonerColors.CONFIRM_SELLER:
                    self.sellerPage()
                elif self.operations.get_color(monitor_seller_character_location, reason='confirm monitor') == SummonerColors.CONFIRM_MONITOR:
                    self.monitorPage()
